...
var bill_date = sheet.getRange(i, 3).getValue();
var bill_date_day = sheet.getRange(i, 71).getValue();
var submitring_date = sheet.getRange(i, 2).getValue();
...
var submit_date_day = sheet.getRange(i, 73).getValue();
